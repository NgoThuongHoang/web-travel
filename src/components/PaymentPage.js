...
const PaymentPage = ({ tourId }) => {
    ...
    useEffect(() => {
        const fetchTour = async () => {
            try {
                ...
                if (!response.ok)
                    throw new Error(
                        `Lỗi khi lấy thông tin tour: ${response.statusText}`
                    );
                ...
                Modal.error({
                    title: "Lỗi",
                    content: `Không thể lấy thông tin tour: ${error.message}`,
                });
            }
        };
        if (tourId) fetchTour();
    ...
    useEffect(() => {
        if (useContactInfo) {
            const contactInfo = formRef.current?.getFieldsValue([
                "username",
                "tel",
            ]);
    ...
    const nguoiLonPrice =
        tour?.prices?.find((p) => p.age_group === "Adult")?.price || 4790000;
    const treEmPrice =
        tour?.prices?.find((p) => p.age_group === "5-11")?.price || 3600000;
    const emBePrice =
        tour?.prices?.find((p) => p.age_group === "Under 5")?.price || 0;
    const phongDonPrice =
        tour?.prices?.find((p) => p.age_group === "Adult")?.single_room_price ||
        2200000;
    ...
    useEffect(() => {
        ...
        const totalPhongDon =
            singleRoomSelections.filter(Boolean).length * phongDonPrice;
        const newTotalPrice =
            totalNguoiLon + totalTreEm + totalEmBe + totalPhongDon;
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (!isAgreed) {
                ...
                Modal.error({
                    title: "Lỗi",
                    content: "Vui lòng đồng ý với Điều khoản thanh toán!",
                });
                return;
            ...
            const leadCustomer = {
                ...
                birth_date: formValues.ngaysinh_traveler_0
                    ? formValues.ngaysinh_traveler_0.format("YYYY-MM-DD")
                    : null,
            ...
            if (
                !leadCustomer.full_name ||
                !leadCustomer.phone ||
                !leadCustomer.email ||
                !leadCustomer.gender ||
                !leadCustomer.birth_date
            ) {
                Modal.error({
                    title: "Lỗi",
                    content: "Vui lòng điền đầy đủ thông tin người đặt tour!",
                });
                return;
            }
            ...
            for (let i = 1; i < totalTickets; i++) {
                ...
                if (!birthDate) {
                    Modal.error({
                        title: "Lỗi",
                        content: `Ngày sinh của ${travelerType} ${i} không hợp lệ!`,
                    });
                    return;
                }
                const traveler = {
                    ...
                    single_room:
                        formValues[`single_room_traveler_${i}`] || false,
            ...
            const specialRequests = [...notes, additionalNotes]
                .filter(Boolean)
                .join(", ");

            // Tính tổng số phòng đơn từ allTravelersForSingleRoom (bao gồm cả Lead)
            const totalSingleRooms = allTravelersForSingleRoom.filter(
                (traveler) => traveler.single_room
            ).length;
            ...
            Modal.error({
                title: "Lỗi",
                content: error.message || "Đã có lỗi xảy ra khi đặt tour!",
            });
        }
    };
        ...
        <div>
                ...
                >
                    <div className="form-container">
                        ...
                        >
                            ...
                            <div className="section-spacing">
                                <Title level={4}>
                                    Quý khách có ghi chú lưu ý gì, hãy nói với
                                    chúng tôi!
                                </Title>
                                <Form.Item name="notes">
                                    <Checkbox.Group>
                                        <Row gutter={[16, 16]}>
                                            <Col span={8}>
                                                <Checkbox value="Hút thuốc">
                                                    Hút thuốc
                                                </Checkbox>
                                            </Col>
                                            <Col span={8}>
                                                <Checkbox value="Phòng tầng cao">
                                                    Phòng tầng cao
                                                </Checkbox>
                                            </Col>
                                            <Col span={8}>
                                                <Checkbox value="Trẻ em hiếu động">
                                                    Trẻ em hiếu động
                                                </Checkbox>
                                            </Col>
                                            <Col span={8}>
                                                <Checkbox value="Ăn chay">
                                                    Ăn chay
                                                </Checkbox>
                                            </Col>
                                            <Col span={8}>
                                                <Checkbox value="Có người khuyết tật">
                                                    Có người khuyết tật
                                                </Checkbox>
                                            </Col>
                                            <Col span={8}>
                                                <Checkbox value="Phụ nữ có thai">
                                                    Phụ nữ có thai
                                                </Checkbox>
                                            </Col>
                                        </Row>
                            ...
                            <div className="section-spacing">
                                <Row gutter={16}>
                                    <Col span={24}>
                                        <Text>
                                            Bằng cách nhập chuột vào nút "ĐỒNG
                                            Ý" dưới đây, Khách hàng đồng ý rằng
                                            các Điều kiện điều khoản này sẽ được
                                            áp dụng. Vui lòng đọc kỹ Điều kiện
                                            điều khoản trước khi thực hiện chọn
                                            sử dụng dịch vụ của Lửa Việt Tours.
                                        </Text>
                                        <Form.Item>
                                            <Checkbox
                                                checked={isAgreed}
                                            ...
                                            {showAgreeError && (
                                                ...
                                                >
                                                    Vui lòng đồng ý với Điều
                                                    khoản thanh toán trước khi
                                                    đặt tour!
                                                </Text>
                                            )}
                                        </Form.Item>
                    ...
                    <div className="summary-container">
                        ...
                        >
                            ...
                            Mã tour: {tour?.tour_code || "HNLCSP4N3D"}
                        </Text>
                        <Title level={4}>
                            {tour?.name ||
                                "MIỀN BẮC 4N3Đ | HÀ NỘI – LÀO CAI – SA PA"}
                        </Title>
                        <Text
                            style={{ display: "block", marginBottom: "10px" }}
                        >
                            {formatDate(tour?.start_date) || "15-03-2025"} →{" "}
                            {formatDate(
                                new Date(
                                    new Date(tour?.start_date).getTime() +
                        ...
                        >
                            <Text>Người lớn:</Text>
                            <Text strong>{`${nguoiLon} x ${formatPrice(
                                nguoiLonPrice
                            )}`}</Text>
                        </div>
                        <div
                        ...
                        >
                            <Text>Trẻ em:</Text>
                            <Text strong>{`${treEm} x ${formatPrice(
                                treEmPrice
                            )}`}</Text>
                        </div>
                        <div
                        ...
                        >
                            <Text>Em bé:</Text>
                            <Text strong>{`${emBe} x ${formatPrice(
                                emBePrice
                            )}`}</Text>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <Text strong>
                                {formatPrice(
                                    singleRoomSelections.filter(Boolean)
                                        .length * phongDonPrice
                                )}
                            </Text>
                        </div>
                        <Divider />
            ...
            >
                <div className="success-modal-content">
                    ...
                    <Text className="success-message">
                        Vui lòng chờ xác nhận từ nhân viên trong thời gian sớm
                        nhất.
                    </Text>
                    <Button
                        type="primary"
